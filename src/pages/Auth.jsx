...
export default function Auth({ onLogin }) {
  ...
  useEffect(() => { codeRefs.current[0]?.focus() }, [step === 'code'])
    ...
    <div className="auth-shell">
      ...
      <div className="auth-card">
        ...
        <div className="auth-logo">
          ...
          <div className="auth-logo-name">Mail<span>Mind</span></div>
        </div>
        ...
        {step === 'mobile' && (
          <>
            ...
            <form onSubmit={handleMobileSubmit} className="auth-form">
              ...
              <button type="submit" className="auth-btn" disabled={loading || mobile.length < 10}>
                Continue →
              </button>
            </form>
        ...
        {step === 'code' && (
          <>
            ...
            <div className="auth-subheading">
              ...
              {mode === 'signup' ? 'you want to set' : 'you set when signing up'}
            </div>
            ...
            {mode === 'signup' && (
              <div className="auth-code-hint">
                💡 Choose any 6 digits you'll remember — this is your permanent password
              </div>
            )}
            ...
            {loading && (
              <div className="auth-loading">
                ...
                <span>{mode === 'signup' ? 'Creating your account…' : 'Logging you in…'}</span>
              </div>
            )}

            {error && <div className="auth-error">{error}</div>}

            <button className="auth-back" onClick={resetToMobile} disabled={loading}>
              ← Back
            </button>
          </>
        )}
        ...
        <div className="auth-footer">
          Your data is encrypted · No passwords stored · <span style={{color:'var(--accent-mid)'}}>Private by design</span>
        </div>
      </div>
    </div>
  )
